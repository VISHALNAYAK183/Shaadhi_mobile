    ...
    try {
      ...
      if (response.message.isNotEmpty) {
        ...
        _showAlert(
          ...
          localizations.translate('success_msg'),
        );
      } else {
        _showAlert(
          localizations.translate('failed'),
          localizations.translate('failure_msg'),
        );
      }
    } catch (e) {
      setState(() => _isLoading = false);
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      buildTextField(
                        '${localizations.translate('matri_id')} *',
                        controller: _matriController,
                      ),
                      buildTextField(
                        '${localizations.translate('name')} * ${localizations.translate('min_char')}',
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 10),
                      Text(
                        localizations.translate('brandname'),
                        style: TextStyle(
                          fontSize: 18,
                          fontWeight: FontWeight.bold,
                        ),
                      ...
                      ..._supportNumbers
                          .map(
                            (number) => Text(
                              '${localizations.translate('phone')}${number.phone}',
                            ),
                          )
                          .toList(),
