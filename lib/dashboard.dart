...
String notification_url = notification?.notiurl ?? "N/A";
  ...
  print("Notification: $notification_url");
    await saveProfileData(
        userScore, expiredate, myName, myMatriId, myImageUrl, myGender,creator_phone);
 ...
 Widget buildLabels(ProfileList profileData) {
  ...
  Widget _buildImageSquareBox(
      String score, String expiredate, String planStatus) {
  ...
  Future<void> saveProfileData(String userScore, String expiredate, String name,
      String matriId, String imageUrl, String myGender,String creator_phone) async {
                  ...
                  children: [
                    ...
                    if (data.advnotifivation != null &&
                      ...
                      if (data.advnotifivation.isNotEmpty)
                        _buildNotificationBox(data.advnotifivation
                            .map((e) => e.notiurl)
                            .toList()),
                    _buildSectionTitle(
  ...
  void _showUploadPopup(String matri_id) {
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        title: Text(localizations.translate('upload_profile'),
            textAlign: TextAlign.center),
        content: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            Icon(Icons.account_circle,
                size: 80, color: Colors.grey), // Profile icon
            SizedBox(height: 10),
            Text(
              localizations.translate('profile_msg'),
            ),
            SizedBox(height: 15),
            ElevatedButton.icon(
              onPressed: () async {
